...
?>
<br>
<p>รายชื่อนิสิตที่ยังไม่มีห้องสอบทฤษฎี ภาค <?echo $sub_semester?></p>
<br>
<a href="#" title="ย้อนกลับ" onClick="reloadPage_2('formFirstRoundLec.php','mainUser','<? echo $key_year_subject; ?>')" ><span class="glyphicon glyphicon-arrow-left"></span>BACK</span></a>
<br>
