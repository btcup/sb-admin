...
<br> Sub-Semester: <label class=\" text-success\">" . $sub_semester . "</label> จำนวนชุด: <label class=\" text-success\" >" . $set .
                " </label>  ส่วนที่: <label class=\" text-success\"> " . $sub_set . " </label> คะแนนเต็ม: <label class=\" text-danger\"> 
            ...
            <div class="row form-group" style=" width: 500px;">
                ...
                <div class="col-sm-4">
                    <select class="form-control" id="secstudent" name="secstudent"
                            onChange="laodScoreLectureSec('queryScoreLecture.php','tableLectureScore','<? echo $key_exam; ?>')">
                        <?
