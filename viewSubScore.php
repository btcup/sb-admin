...
echo $width_table;*/
?>
<a href="#" onClick="loadViewScoreTeacher('viewScoreTeacher.php','mainUser','<? echo $key_sec_subject; ?>')"><span class="glyphicon glyphicon-arrow-left"></span>BACK</a>
<br>
				...
				if($num != 0){
					while($row = mysqli_fetch_array($result)){
						...
						if($chkNull == 0)
							...
							echo '<td style="text-align: center;" bgcolor="#FF0000" >   </td>';
					}
				}else{
				...
				if($chk_practice_mid == 0){
					...
					while($row = mysqli_fetch_array($result)){
						...
						if($chkNull == 0)
								...
								echo '<td style="text-align: center;" bgcolor="#FF0000" >'.$row['set_exam'].'_'.$row['article_exam'].'</td>';
					}
