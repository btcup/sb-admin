...
$sql = "SELECT * FROM round_exam_lec WHERE key_round = '$key_round'";
...
<div id="mainUser" class="container">
 <a href="#" onClick="reloadPage_2('formFirstRoundLec.php','mainUser','<? echo $key_year_subject; ?>')"><span class="fa fa-arrow-left">BACK</span></a>
    <br>
    ...
    <table class="table table-striped" style="width: 800px; margin: auto;">
        ...
        $sql = "SELECT * FROM generate_password_lec 
				INNER JOIN student ON student.key_student = generate_password_lec.key_student
