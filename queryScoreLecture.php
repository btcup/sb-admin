...
$sql = "SELECT * FROM set_lecture_exam WHERE key_set_lExam = '$key_exam'";
		  ...
		  while($row = mysqli_fetch_array($result))
		  {
			  ...
			  while($row_student = mysqli_fetch_array($result_student))
			  {
				   $count_s_p++;
					...
					onChange="updateScore(\'php/updateScore.php\',\'myDiv\',\'score_gather_dynamic\',\''.$key_student.'\',\''.$key_score_lecture.'\',this,\''.$current_score.'\',\''.$full_score.'\')"></td>';
              		echo '<td style=""><textarea class="form-control"
					id="'.$str_note.'" 
					onChange="updateNote(\'php/updateNote.php\',\'myDiv\',\'score_gather_dynamic\',\''.$str_note.'\',\''.$key_score_lecture.'\',\''.$key_student.'\')">'.$current_note.'</textarea></td>';
			  		echo '</tr>';
