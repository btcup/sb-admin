                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered" id="TB1" cellspacing="0">
                        ...
                        while($rowlocal = mysqli_fetch_array($result))
                        {
                            ...
                            echo '<td>' . $semester . '</td>';
                            echo '<td>' . $subject .'</td>';
                            echo '<td><a href="#" onClick="loadEdit_2(\'formEdit.php\',\'mainUser\',\''.$key_year_subject.'\')" id="'.$key_year_subject.'">'.$num_amount.'</a></td>';
                            echo '<td style="text-align: center;"><ol class="breadcrumb">
        			<li><a href="#" title="Delete" onClick="deleteSubject_2(\'php/deleteSubject.php\',\'mainUser\',\''.$key_year_subject.'\'),top.location.href=\'admin.php\';" id="'.$key_year_subject.'"><span class="fa fa-trash-o fa-lg"></span>   &nbsp;  &nbsp;</a></li>
        			<li><a href="#" title="Edit" onClick="loadEdit_2(\'formEdit.php\',\'mainUser\',\''.$key_year_subject.'\')" id="'.$key_year_subject.'"><span class="fa fa-edit fa-lg"></span>   &nbsp;  &nbsp;</a></li>
					<li><a href="#" title="Veiw detail" onClick="loadEdit_2(\'formUserView.php\',\'mainUser\',\''.$key_year_subject.'\')" id="'.$key_year_subject.'"><span class="fa fa-list fa-lg"></span>   &nbsp;  &nbsp;</a></li>
