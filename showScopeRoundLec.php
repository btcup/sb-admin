...
<div id="mainUser" class="container" >
    ...
    <table class="table table-striped" style="width: 900px; margin: auto;">
        ...
        while($row = mysqli_fetch_array($result))
        {
            ...
            $sql = "SELECT * FROM generate_password_lec WHERE round_room = '$key_round'";
            ...
            echo '<td style="text-align: center;">
                  <ol class="breadcrumb">
                  <div id="HighJa">
				<li class="IL"><a href="#" onClick="editRound2(\'editRoundLec.php\',\'mainUser\',\''.$key_year_subject.'\',\''.$key_round.'\',\''.$numofexam.'\')" title="ดูนิสิตในห้องสอบ"><span class="fa fa-user"></span></a></li>
