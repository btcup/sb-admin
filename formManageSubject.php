    ...
    <div class="card mb-3 out" style="background:lightgray;">
        ...
        <div id="mainUser1" class="label-info">
            ...
            <div class="card-body">
			  ...
			  <ol class="breadcrumb">
			  <li><a href="#" onClick="editSubject(\'editSubject.php\',\'edit\',\''.$id_subject.'\')" title="แก้ไข"><span class="fa fa-edit fa-lg" style="width: 25px"></span></a></li>
			  <li><a href="#" onClick="deleteSubjectOnly(\'php/deleteSubjectOnly.php\',\''.$id_subject.'\'); window.location.reload(true)" title="ลบ"><span class="fa fa-trash-o fa-lg" style="width: 25px"></span></a></li>
		  	  </ol>
			  </td>';
