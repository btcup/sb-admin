...
if($chk_dup == 0)
{
    for($i=1 ; $i <= $num_round ; $i++)
    {
        ...
        $sql = "INSERT INTO round_exam_lec (round_number,date,time_start,time_end,sub_semester,key_year_subject)
		VALUES('$i','$date','$time_start','$time_end','$sub_semester','$key_year_subject')";
        $result = mysqli_query($database,$sql);
    }
