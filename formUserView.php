	...
	WHERE key_year_subject = '$key_year_subject'";
        ...
        <div id="viewSubScore">
            <div id="tableStudentView">
               ...
               onClick="loadSubScore('viewSubScore2.php','viewSubScore','<? echo $key_year_subject; ?>','<? echo $first_sec; ?>')"><span
               class="glyphicon glyphicon-eye-open"></span></a></div>
                <table class="table table-bordered" style=" width: 1500px; margin-left: auto">
                    <thead>
                    <tr>
                        <th style=""></th>
                        <th style=""></th>
...
<!--                        //headtable score lecture final-->
                        ...
                        if ($chknumscore != 0) {
                            while ($row_resultsqlscore = mysqli_fetch_array($resultsqlscore)) {?>
                                <th style="width: 100px;  "><div id="verti"><? echo "L_F_NO.". $row_resultsqlscore['numofexam']."<br>"."เต็ม(".$row_resultsqlscore['score'].")"; ?></div></th>
                        ...
                        if ($chknumscore != 0) {
                            while ($row_resultsqlscore = mysqli_fetch_array($resultsqlscore)) {?>
                                <th style="width: 100px;  "><div id="verti"><? echo "P_F_NO.". $row_resultsqlscore['numofexam']."ชุดที่".$row_resultsqlscore['set_exam']."เต็ม(".$row_resultsqlscore['score'].")"; ?></div></th>
