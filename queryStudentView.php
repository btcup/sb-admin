...
$key_sec_subject = $_POST['key_sec'];
$key_year_subject = $_POST['key_exam'];
?>
        ...
        <div style="width: 900px; text-align:center; margin: auto;"><a href="#" title="ดูรายละเอียดคะแนน"
                                                                       onClick="loadSubScore('viewSubScore2.php','viewSubScore','<? echo $key_sec_subject; ?>','<? echo $first_sec; ?>')"><span
