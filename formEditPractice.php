...
<label> อาจารย์: </label>
<select class="form-control" style="width: 300px;" id="slteacher" name="slteacher" >
...
<input type="button" onClick="queryEditPractice2('php/editPractice.php','mainUser','<? echo $key_set; ?>','<? echo $key_year_subject ?> '
	,'<? echo $sub_semester; ?>','<? echo $set; ?>','<? echo $round; ?>')" id="btedit" class="btn btn-info" value="แก้ไข" style="width: 100px;"
