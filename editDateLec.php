...
<form class="form-inline" role="form">
    ...
    <input type="button" id="btedit" class="btn btn-info" value="แก้ไข" style="width: 150px;"
           onClick="editManualDate('php/updateDateLec.php','<? echo $key_year_subject; ?>','<? echo $sub_semester; ?>','<? echo $old_date; ?>')">

    <input type="button" id="cancle" class="btn btn-danger" value="ยกเลิก" style="width: 150px;"
           onClick="loadSetPExam('formFirstRoundLec.php','mainUser','<? echo $key_year_subject; ?>')">
</form>
