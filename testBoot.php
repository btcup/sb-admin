...
<div class="container" style="width: 1260px; margin: auto; margin-top: 20px;"> 
    ...
    <div id="section" class="jumbotron" style="float:right; width: 80%; height: 500px; margin: 0px;">
    <a href="#" title="Delete" id="'.$key_year_subject.'"><span class="glyphicon glyphicon-trash"></span></a>
    </div>
</div>
