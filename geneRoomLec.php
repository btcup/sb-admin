...
<form class="form-horizontal" role="form" style="width: 700px; margin: auto;">
    ...
    for($i = 1 ; $i <= $num_room ; $i++)
    {
        ...
        <div class="form-group">
            <div class="col-sm-2">
                <label class=" control-label">Lec ห้องที่: <? echo $i; ?></label>
            </div>
            <div class="col-sm-3">
...
<form class="form-horizontal" role="form" style="width: 500px; margin: auto;">
    <input type="button" id="submit" class="btn btn-primary" style="width: 150px;" value="เพิ่มข้อมูล"
           onClick="addRoomInRound_2Lec('php/addRoomInRoundLec.php','<? echo $key_year_subject; ?>','<? echo $sub_semester; ?>','<? echo $date; ?>','<? echo $round_number; ?>','<? echo $num_room; ?>')">
    <input type="button" id="submit" class="btn btn-danger" style="width: 150px;" value="ยกเลิก"
           onClick="showRoomInRound_2('showRoomInRoundLec.php','mainUser','<? echo $key_year_subject; ?>','<? echo $sub_semester; ?>','<? echo $date; ?>','<? echo $round_number; ?>')">
</form>
</body>
</html>