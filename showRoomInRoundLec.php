...
<div id="mainUser" class="container" style="background-color: lightblue;">
    ...
    <a href="#" title="ย้อนกลับ" onClick="editRound_2('formEditRoundLec.php','mainUser','<? echo $key_year_subject; ?>','<? echo $sub_semester; ?>','<? echo $date; ?>')">
    ...
    <form class="form-inline" role="form">
        ...
        <input type="button" id="sbset" name="sbset" value="ตกลง" class="btn btn-info" style=" width: 150px;"
               onClick="geneRoom_2('geneRoomLec.php','geneRoom','<? echo $key_year_subject; ?>','<? echo $sub_semester; ?>','<? echo $date; ?>','<? echo $round_number; ?>')">
    </form>
