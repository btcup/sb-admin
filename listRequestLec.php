...
<div class="card-header">
    <a class="fa fa-table"> จัดรอบการสอบทฤษฎี<? echo " ".$class_subject; ?></a>
</div>
<br><br>
<div style="width: 800px; margin: auto;">
    <a href="#" title="ย้อนกลับ" onClick="reloadPage_2('formFirstRoundLec.php','mainUser','<? echo $key_year_subject; ?>')" ><span class="fa fa-arrow-left"></span>BACK</span></a>
</div>
<br>
<div style="width: 800px; margin: auto;">
...
<table class="table table-striped" style="width: 500px; margin: auto;">
    ...
    <?
    $sql = "SELECT DISTINCT numofexam,date,round_number,time_start,time_end FROM round_exam_lec WHERE key_year_subject = '$key_year_subject'
...
<table class="table table-striped" style="width: 1100px; margin: auto;">
    ...
    <?
    $i = 0;
    $sql_request = "SELECT request_lec.numofexam,request_lec.key_request,request_lec.key_student,time_start,time_end,date,sec_subject.number
        ,student.id_student,student.name_student,reason FROM request_lec
    ...
    while($row_request = mysqli_fetch_array($result_request)){
        ...
        echo '<td style="text-align: center;">
          <a href="#" onClick="deleteRequestFromTeacher_2Lec(\'php/deleteRequestFromTeacherLec.php\',\''.$key_request.'\',\''.$key_year_subject.'\',\''.$sub_semester.'\')"
