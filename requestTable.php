...
if($chknum != 0)
{
	while($row = mysqli_fetch_array($result))
	{
		...
		$reason = $row['reason'];
         ...
         echo '<td style=" text-align: center;"><a href="" onClick="deleteRequest(\'php/deleteRequest.php\',\''.$key_request.'\')" title="Delete"><span class="glyphicon glyphicon-trash"></span></a></td>';
         echo '</tr>';
	}
}
}
